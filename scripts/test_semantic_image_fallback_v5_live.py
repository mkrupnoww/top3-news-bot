...
async def main() -> int:
    """
    Выполняет один изолированный реальный semantic fallback v5.
    ...
    try:
        ...
        # --------------------------------------------------------------
        # 2. Создаём runtime и явно включаем semantic fallback v5.
        # --------------------------------------------------------------
